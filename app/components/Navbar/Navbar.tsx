...
const Navbar = () => {
     ...
     return (
          <header className='sticky header flex-center z-50 animate__animated animate__fadeIn animate__delay-1s'>
                    ...
                    <BackgroundGradient className="rounded-full bg-white/80 dark:bg-zinc-800/80">
                         <Menu setActive={setActive}>
                              {links.filter(x => x.name !== 'Blog').map((link) =>
                                   <Link
                                        key={link.id}
                                        className={'hover-text-gradient ' + (pathname === link.name && 'active-text-gradient')}
                                        href={link.href}
                                   >
                                        {link.name}
                                   </Link>
